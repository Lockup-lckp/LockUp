...
export default function HistoricoPagamentos() {
  ...
  return (
    <>
      {/* Estilos globais para forçar o PDF no formato A4 e com cores reais */}
      <style type="text/css" media="print">
        {`
          ...
          /* Previne cortes quebrando tabelas no meio */
      ...
      {/* ÁREA DA TELA (Oculta na impressão) */}
      <div className="p-4 sm:p-6 bg-[var(--bg-color)] min-h-screen text-white font-sans print:hidden">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 bg-[var(--surface-color)] border border-[var(--border-color)] rounded-xl text-sm text-white outline-none focus:border-[var(--primary-color)] transition-all"
            >
      ...
      {/* ÁREA DE IMPRESSÃO (Aparece apenas no PDF gerado) */}
      <div className="hidden print:block print:w-full print:bg-white print:text-black">
        {/* Componente que renderiza os dados completos para impressão */}
        <RelatorioAnual
          escola={escola}
          ano={anoSelecionado}
